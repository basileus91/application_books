...
insert into "user" (id,email,"password","name",last_name,active) values(1,'vasiafurdui@yahoo.com','$2a$10$tvdPysi5VIZvjdS492QU5uHmV6Qzhrj1njY9ZtuoXEj9JFWzGuche','Vasile','Furdui',true);
insert into user_role (user_id,role_id) values (1,1);

insert into "user" (id,email,"password","name",last_name,active) values(2,'vasia.furdui@gmail.com','$2a$10$tvdPysi5VIZvjdS492QU5uHmV6Qzhrj1njY9ZtuoXEj9JFWzGuche','Vasile','Furdui',true);
